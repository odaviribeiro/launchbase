...
const programador = {
  ...
  idade: 20,
  tecnologias: [
    { nome: 'Javascript', especialidade: 'Desktop, Mobile && Web' },
    { nome: 'HTML', especialidade: 'Web, Mobile && Desktop' }
  ]
};

console.log(`O usuário ${programador.nome} tem ${programador.idade} anos e usa a tecnologia ${programador.tecnologias[0].nome} com especialidades em ${programador.tecnologias[0].especialidade}.`)